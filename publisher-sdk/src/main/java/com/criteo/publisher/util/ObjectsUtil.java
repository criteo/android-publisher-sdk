...
/**
 * Utility methods copied from the Standard Objects Java class. This class is only available
 * starting from Java 8, which is only available since API level 19. However we support devices down
 * to API level 16.
 *
 * <p>
...
public class ObjectsUtil {
   ...
   * Object#hashCode()} on objects containing multiple fields. For example, if an object that has
