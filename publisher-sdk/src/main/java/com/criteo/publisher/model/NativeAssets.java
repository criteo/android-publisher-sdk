    ...
    public boolean equals(Object obj) {
        if (obj instanceof NativeAssets) {
            ...
            return (this.nativeProducts.equals(other.nativeProducts) &&
                    (this.advertiserDescription == other.advertiserDescription || this.advertiserDescription.equals(other.advertiserDescription)) &&
                    (this.advertiserDomain == other.advertiserDomain || this.advertiserDomain.equals(other.advertiserDomain)) &&
                    (this.advertiserLogoUrl == other.advertiserLogoUrl || this.advertiserLogoUrl.equals(other.advertiserLogoUrl)) &&
                    this.advertiserLogoHeight == other.advertiserLogoHeight &&
                    this.advertiserLogoWidth == other.advertiserLogoWidth &&
                    (this.advertiserLogoClickUrl == other.advertiserLogoClickUrl || this.advertiserLogoClickUrl.equals(other.advertiserLogoClickUrl)) &&
                    (this.privacyOptOutClickUrl == other.privacyOptOutClickUrl || this.privacyOptOutClickUrl.equals(other.privacyOptOutClickUrl)) &&
                    (this.privacyOptOutImageUrl == other.privacyOptOutImageUrl || this.privacyOptOutImageUrl.equals(other.privacyOptOutImageUrl)) &&
                    (this.privacyLongLegalText == other.privacyLongLegalText || this.privacyLongLegalText.equals(other.privacyLongLegalText)) &&
