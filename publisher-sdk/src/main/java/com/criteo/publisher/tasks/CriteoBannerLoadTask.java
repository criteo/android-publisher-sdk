...
public class CriteoBannerLoadTask extends AsyncTask<Object, Void, Object> {
    ...
    /**
     * Taking WebViewClient as a constructor as all WebView/CriteoBannerView methods
     * must be called on the same UI thread.
     * WebView.getSettings().setJavaScriptEnabled() & WebView.setWebViewClient()
