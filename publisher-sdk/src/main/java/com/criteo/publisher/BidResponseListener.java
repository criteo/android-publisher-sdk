...
public interface BidResponseListener {
   ...
   * <code>null</code> and its CPM is accessible through {@link BidResponse#getPrice()}.
   *
   ...
   * <ul>
   *   <li>{@link CriteoBannerView#loadAd(BidResponse)}: display a banner</li>
   *   <li>{@link CriteoInterstitial#loadAd(BidResponse)}: display an interstitial</li>
   *   <li>{@link CriteoNativeLoader#loadAd(BidResponse)}: display a native ad</li>
   * </ul>
   * <p>
   * Please note that the <code>loadAd</code> method should match the kind of Ad the bid was asked for.
   *
   * @param bidResponse <code>null</code> in case of no bid, or a bid object that can be used to display an Ad
   * @see <a href="https://publisherdocs.criteotilt.com/app/android/app-bidding/inhouse/">InHouse documentation</a>
   */
  void onResponse(@Nullable BidResponse bidResponse);
}
