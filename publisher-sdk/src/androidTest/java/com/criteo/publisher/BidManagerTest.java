...
public class BidManagerTest {
  ...
  public void testPlacementAdditionInPrefetch() throws InterruptedException {
    ...
    CacheAdUnit cacheAdUnit1 = new CacheAdUnit(adSize, "SampleBannerAdUnitId1",
        AdUnitType.CRITEO_BANNER);
    CacheAdUnit cacheAdUnit2 = new CacheAdUnit(adSize_2, "SampleBannerAdUnitId2",
        AdUnitType.CRITEO_BANNER);

    BannerAdUnit bannerAdUnit1 = new BannerAdUnit(cacheAdUnit1.getPlacementId(),
        cacheAdUnit1.getSize());
    BannerAdUnit bannerAdUnit2 = new BannerAdUnit(cacheAdUnit2.getPlacementId(),
  ...
  public void testDfpBannerInterstitialKeywordsReflection() {
    ...
    CacheAdUnit cAdUnit = new CacheAdUnit(new AdSize(320, 50), "bannerAdunitId",
        AdUnitType.CRITEO_BANNER);
    ...
    when(sdkCache.peekAdUnit(cAdUnit)).thenReturn(testSlot);
  ...
  public void testDfpNativeKeywordsReflection() {
    ...
    when(config.isKillSwitchEnabled()).thenReturn(false);
    List<CacheAdUnit> cacheAdUnits = new ArrayList<>();
    CacheAdUnit cAdUnit = new CacheAdUnit(new AdSize(2, 2), "nativeAdunitId",
        AdUnitType.CRITEO_CUSTOM_NATIVE);
    cacheAdUnits.add(cAdUnit);
    ...
    assertEquals(
        deviceUtil.createDfpCompatibleString("https://cat.sv.us.criteo.com/delivery/ckn.php"),
    ...
    assertEquals(
        deviceUtil.createDfpCompatibleString("https://static.criteo.net/flash/icon/nai_small.png"),
    ...
    assertEquals(
        deviceUtil.createDfpCompatibleString("https://cat.sv.us.criteo.com/delivery/lgn.php?"),
    ...
    assertEquals(
        deviceUtil.createDfpCompatibleString("https://dog.da.us.criteo.com/delivery/lgn.php?"),
  ...
  */
  ...
  public void testEnrichNativeRequestWithNullProducts() {
    ...
    when(sdkCache.peekAdUnit(cacheAdUnit)).thenReturn(slot);
