...
export aar_file_to_upload="com/criteo/publisher/$artifact_id/$release/${artifact_id}-${release}.aar"
export aar_blob_name="android/$aar_file_to_upload"

export pom_file_to_upload="com/criteo/publisher/$artifact_id/$release/${artifact_id}-${release}.pom"
export pom_blob_name="android/$pom_file_to_upload"

export mvn_file_to_upload="com/criteo/publisher/$artifact_id/maven-metadata.xml"
export mvn_blob_name="android/$mvn_file_to_upload"
